...
const translations: Record<Locale, Record<string, string>> = {
  "zh-TW": {
    ...
    "nav.skills": "技能管理",
    "nav.skillStore": "技能商店",
    "nav.lobsterArmy": "龙虾军团",
    "nav.agentChannel": "Agent频道",
    "nav.alerts": "警報中心",
    ...
    // auth
    "auth.welcome": "歡迎使用 OpenClaw 管理後台",
    "auth.password": "管理員密碼",
    "auth.passwordPlaceholder": "請輸入密碼",
    "auth.login": "登入",
    "auth.loggingIn": "登入中...",
    "auth.loginFailed": "登入失敗，請檢查密碼",
    "auth.logout": "登出",
    "auth.version": "版本",
    "auth.required": "請先登入",
    ...
    "models.addFailed": "添加模型失敗",
    "models.deleteFailed": "刪除模型失敗",
    "models.confirmDelete": "確定要刪除此模型嗎？",
    "models.saving": "保存中...",
    "models.providerId": "Provider ID",
    "models.baseUrl": "Base URL",
    "models.selectBrand": "快速選擇品牌",
    "models.modelId": "模型 ID",
    "models.modelName": "模型名稱",
    "models.apiKey": "API Key",
    "models.accessMode": "接入方式",
    "models.contextWindow": "上下文窗口",
    "models.maxTokens": "最大輸出 Token",
    "models.supportReasoning": "支持推理",
    "models.delete": "刪除",
    "models.edit": "編輯",
    "models.status": "狀態",
    "models.statusOnline": "在線",
    "models.statusOffline": "離線",
    "models.probeFetch": "🔍 獲取模型",
    "models.probeSelectModel": "— 選擇模型 —",
    "models.probeNeedApiKey": "請先填寫 API Key",
    "models.probeNoModels": "未找到可用模型",
    "models.probeFailed": "獲取模型失敗",
    "models.colModel": "模型",
    "models.colProvider": "Provider",
    "models.colStatus": "狀態",
    "models.colActions": "操作",
    "models.modelList": "模型列表",
    "models.modelCount": "個模型",
    "models.noModels": "暫無模型，點擊添加",
    "common.save": "保存",
    "common.cancel": "取消",
    ...
    "skillStore.subtitle": "探索、安裝和管理 OpenClaw 技能",
    "skillStore.mySkills": "我的技能",
    "skillStore.search": "搜尋技能...",
    "skillStore.all": "全部",
    "skillStore.builtin": "內建",
    "skillStore.extension": "擴充",
    "skillStore.custom": "自訂",
    "skillStore.install": "安裝",
    "skillStore.installing": "安裝中...",
    "skillStore.uninstall": "移除",
    "skillStore.uninstalling": "移除中...",
    "skillStore.installSuccess": "安裝成功",
    "skillStore.installFailed": "安裝失敗",
    "skillStore.uninstallSuccess": "移除成功",
    "skillStore.uninstallFailed": "移除失敗",
    "skillStore.confirmUninstall": "確定要移除此技能嗎？",
    "skillStore.noResults": "找不到符合的技能",
  ...
  zh: {
    ...
    "nav.skills": "技能管理",
    "nav.skillStore": "技能商店",
    "nav.lobsterArmy": "龍蝦軍團",
    "nav.agentChannel": "Agent頻道",
    "nav.alerts": "告警中心",
    ...
    // auth
    "auth.welcome": "欢迎使用 OpenClaw 管理后台",
    "auth.password": "管理员密码",
    "auth.passwordPlaceholder": "请输入密码",
    "auth.login": "登录",
    "auth.loggingIn": "登录中...",
    "auth.loginFailed": "登录失败，请检查密码",
    "auth.logout": "退出登录",
    "auth.version": "版本",
    "auth.required": "请先登录",
    ...
    "models.addFailed": "添加模型失败",
    "models.deleteFailed": "删除模型失败",
    "models.confirmDelete": "确定要删除此模型吗？",
    "models.saving": "保存中...",
    "models.providerId": "Provider ID",
    "models.provider": "Provider",
    "models.baseUrl": "Base URL",
    "models.selectBrand": "快速选择品牌",
    "models.modelId": "模型 ID",
    ...
    "models.edit": "编辑",
    "models.status": "状态",
    "models.statusOnline": "在线",
    "models.statusOffline": "离线",
    "models.probeFetch": "🔍 获取模型",
    "models.probeSelectModel": "— 选择模型 —",
    "models.probeNeedApiKey": "请先填写 API Key",
    "models.probeNoModels": "未找到可用模型",
    "models.probeFailed": "获取模型失败",
    "models.colModel": "模型",
    "models.colProvider": "Provider",
    "models.colStatus": "状态",
    "models.colActions": "操作",
    ...
    // skill store
    "skillStore.title": "技能商店",
    "skillStore.subtitle": "探索、安装和管理 OpenClaw 技能",
    "skillStore.mySkills": "我的技能",
    "skillStore.search": "搜索技能...",
    "skillStore.all": "全部",
    "skillStore.builtin": "内置",
    "skillStore.extension": "扩展",
    "skillStore.custom": "自定义",
    ...
    "skillStore.uninstallSuccess": "移除成功",
    "skillStore.uninstallFailed": "移除失败",
    "skillStore.confirmUninstall": "确定要移除此技能吗？",
    "skillStore.noResults": "找不到匹配的技能",
  ...
  en: {
    ...
    "nav.lobsterArmy": "Lobster Army",
    "nav.agentChannel": "Agent Channel",
    "nav.alerts": "Alerts",
    ...
    // auth
    "auth.welcome": "Welcome to OpenClaw Dashboard",
    "auth.password": "Admin Password",
    "auth.passwordPlaceholder": "Enter password",
    "auth.login": "Login",
    "auth.loggingIn": "Logging in...",
    "auth.loginFailed": "Login failed, please check your password",
    "auth.logout": "Logout",
    ...
    "models.addFailed": "Failed to add model",
    "models.deleteFailed": "Failed to delete model",
    "models.confirmDelete": "Are you sure you want to delete this model?",
    "models.saving": "Saving...",
    "models.providerId": "Provider ID",
    "models.baseUrl": "Base URL",
    "models.selectBrand": "Quick Select Brand",
    "models.modelId": "Model ID",
    "models.modelName": "Model Name",
    "models.apiKey": "API Key",
    "models.accessMode": "Access Mode",
    "models.contextWindow": "Context Window",
    "models.maxTokens": "Max Output Tokens",
    "models.supportReasoning": "Support Reasoning",
    "models.delete": "Delete",
    "models.edit": "Edit",
    "models.status": "Status",
    "models.statusOnline": "Online",
    "models.statusOffline": "Offline",
    "models.probeFetch": "🔍 Fetch Models",
    "models.probeSelectModel": "— Select a model —",
    "models.probeNeedApiKey": "Please enter API Key first",
    "models.probeNoModels": "No models found",
    "models.probeFailed": "Failed to fetch models",
    ...
    "models.noModels": "No models yet, click to add",
    "common.save": "Save",
    ...
    "skillStore.subtitle": "Explore, install and manage OpenClaw skills",
    "skillStore.mySkills": "My Skills",
    "skillStore.search": "Search skills...",
    "skillStore.all": "All",
    "skillStore.builtin": "Built-in",
    "skillStore.extension": "Extension",
    "skillStore.custom": "Custom",
    ...
    "skillStore.installFailed": "Installation failed",
    "skillStore.uninstallSuccess": "Uninstalled successfully",
    "skillStore.uninstallFailed": "Uninstall failed",
    "skillStore.confirmUninstall": "Are you sure you want to uninstall this skill?",
